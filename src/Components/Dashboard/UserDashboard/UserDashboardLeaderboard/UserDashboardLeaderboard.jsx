                ...
                <div className="h-[907px] bg-contain bg-[#002642] rounded-2xl w-full bg-no-repeat my-5  bg-center">
                    <div className='w-full flex justify-center relative'>
                        <div style={{
                            ...
                            background: "linear-gradient(221deg, #002E50 15.94%, #052135 81.53%)",
                            boxShadow: "2.156px 6.469px 25.877px 0px rgba(255, 255, 255, 0.15) inset"
                            ...
                            <div className='flex justify-center gap-3 mt-[80px]'>
                                ...
                                <div className='w-[69px] h-[69px] bg-[#B8F041] rounded-full pt-[11.5px] pr-[11.377px] pb-[11.502px] pl-[16.101px]'>
                                    ...
                                    <p className='mb-2 text-[19px] font-medium bg-[#FF557A] py-[8.626px] rounded-3xl px-[28.443px]'>4 hr 30 min</p>
                                    <img src={silver} alt="" />
                                </div>
                    ...
                    <div className="h-1/2 bg-contain bg-no-repeat bg-center relative" style={{ backgroundImage: `url(${overlay1})`, zIndex: 20 }}>
