                ...
                addMember === true ?
                    <div className="w-11/12 mx-auto mt-10">
                        ...
                        <form className="mt-3" autocomplete="on">
                            <h1 className="font-semibold text-[18px] tracking-widest my-3">Add team member</h1>
                            <div className="flex flex-col gap-2 my-4">
                                <label htmlFor="memberName" className="text-[17px] font-medium">Team member name</label>
                                <input placeholder="write team member name" type="text" name="memberName" id="memberName" className="bg-[#EEF0FF] px-[10px] py-1 rounded-md shadow" />
                            </div>
                            <div className="flex flex-col gap-2 my-4">
                                <label htmlFor="memberDesignation" className="text-[17px] font-medium">Team member designation</label>
                                <input placeholder="Ex. Product Manager" type="text" name="memberDesignation" id="memberDesignation" className="bg-[#EEF0FF] px-[10px] py-1 rounded-md shadow" />
                            </div>
                            <div className="flex flex-col gap-2 my-4">
                                <label htmlFor="memberMail" className="text-[17px] font-medium">Team member email id</label>
                                <input placeholder="write team member email id" type="email" name="memberMail" id="memberMail" className="bg-[#EEF0FF] px-[10px] py-1 rounded-md shadow" />
                            </div>
                            <div className="flex flex-col gap-2 my-4">
                                <label htmlFor="memberNumber" className="text-[17px] font-medium">Team member mobile number</label>
