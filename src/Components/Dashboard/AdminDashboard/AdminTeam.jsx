              ...
              <table className="table w-full">
                ...
                <tbody className="w-full ">
                  <tr className="border border-[#E2E2E2]">
                    <td className="flex items-center gap-1 text-[15px] font-medium my-2">
                      <IoPersonCircleOutline className="h-[29px] w-[29px]" />{" "}
                      Himanshu sir
                    </td>
                    <td className="text-[15px] font-medium">
                      Senior marketing head
                    </td>
                    <td>
                      <div className="flex gap-6 items-center">
                        <button className="text-[18px] bg-[#DD2025] w-24 text-[#FFF] rounded-3xl">
                          Delete
                        </button>
                        <button className="text-[18px] bg-[#6278FF] w-20 text-[#FFF]  rounded-3xl">
                          Edit
                        </button>
              ...
              <>
                ...
                <div className="flex gap-5">
                  ...
                  <div className="my-4 bg-[#FFF] border w-[315px] border-[#E7E7E7] shadow-md  shadow-[#E7EAFF] px-[7px] py-[12px] rounded-md">
                    ...
                    <div className="mt-3 flex justify-around items-center">
                      <button className="border border-[#0D47A1] text-[#0D47A1] py-[3px] px-4  rounded-3xl text-[14px] font-medium flex items-center gap-1">
                        <GoShieldLock className="w-6 h-5" /> Public{" "}
