        ...
        <div className="w-[100%] h-[533px] border-[#E8E8E8] border-2 shadow-sm rounded-md my-8">
            <div className='w-5/6 mx-auto flex justify-between items-center mt-[32px]'>
                <div className='grid items-center'>
                        <p className='text-[#828282] text-[17.71px] font-semibold'>School Performance</p>
            ...
            <LineChart
                series={[
                    { data: uData,curve: "linear", label: 'Top Schools', color: '#3E4DAC' },
                ]}
...
export default SchoolDashboardBottom;