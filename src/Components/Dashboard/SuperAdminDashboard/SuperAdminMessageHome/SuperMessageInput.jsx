...
const SuperMessageInput = ({ selectedChat, messages, setMessages, setLastMessage, socketConnected, setSocketConnected, read , setRead}) => {
...
export default SuperMessageInput;
