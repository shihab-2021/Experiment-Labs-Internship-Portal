                ...
                <div className="w-full">
                  ...
                  <div className="flex items-center justify-between w-full">
                    ...
                    <button
                      ...
                      className="w-[136px] h-9 px-[26px] py-2.5 bg-white rounded-[26px] border border-sky-500 justify-center items-center gap-2.5 inline-flex text-sky-500 text-xl font-normal font-raleway leading-[15.08px]"
                    >
                      Message
                    </button>
                  </div>
