...
const List = () => {
    return (
        <div className='flex gap-5'>
            <div className="justify-center items-stretch shadow-sm max-w-[170px] min-w-[170px] bg-indigo-800 flex flex-col px-2 rounded-md py-4">
            ...
            <div className="justify-center items-stretch shadow-sm max-w-[170px] min-w-[170px] bg-[#E8B912] flex flex-col px-2 rounded-md py-4">
                <div className="justify-between items-stretch flex gap-5">
                    <div className="text-white text-sm font-medium tracking-widest">
                        Selected Students
                    </div>
