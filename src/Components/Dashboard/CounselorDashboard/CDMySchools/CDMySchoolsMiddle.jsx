  ...
  return (
    ...
    >
      ...
      {/* Add more options as needed */}
        ...
        <div className="mt-10" style={{ width: "100%", height: "400px" }}>
          <BarChart
            series={[
              {
                data: participant_in_tasks,
                label: "Participant in tasks",
                id: "pvId",
                color: "#8064F0",
              },
              {
                data: select_in_tasks,
                label: "Select in tasks",
                id: "svId",
                color: "#E8B912",
              },
              {
                data: reject_in_tasks,
                label: "Reject in tasks",
                id: "rvId",
                color: "#DD2025",
              },
            ]}
      ...
      <div className="border-[#EEE] w-[35%] border-2 shadow-sm h-[522px] rounded-md">
        <p className="w-11/12 mx-auto my-2 font-medium tracking-wide">
          Top Students
        </p>
        <div className="grid justify-center items-center font-medium border-[#E3E3E3] rounded-md">
          <select
            className=" border-[#E3E3E3] w-[180px] border-2 rounded-md py-[8px]"
            name="schools"
            id="schools"
          >
            <option className="" value="schools">
...
export default CDMySchoolsDashboardMiddle;
