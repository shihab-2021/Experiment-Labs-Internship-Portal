    ...
    <div className="w-11/12 mx-auto">
      <div className="grid justify-items-center md:flex md:justify-between md:items-center">
        <div className=" md:w-1/2">
          <h1 className="mt-[121px] md:w-[534px] text-[30px] md:text-[45px] font-bold leading-[50px]">
            <span className="text-[#4250AC]">Connecting</span> talent with
            recruiters.
          </h1>
          <p className="text-[16px] md:mt-[17px] text-[#797979] md:text-[19px] leading-6 font-bold">
            Explore opportunities from across the globe to learn, showcase
            skills, gain CV points.
          </p>
          <button
            onClick={() => setShowLoginForm(true)}
            className="text-white bg-[#4250AC] py-[13px] px-[28px] text-[18px] mt-[18px] rounded-3xl"
          >
            Apply now
          </button>
