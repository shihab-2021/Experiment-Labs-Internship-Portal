...
import image12 from "../../../assets/UpdatedHome/image 12.webp";
    ...
    <div className="bg-[#F0F5FF] md:py-2 mt-16 md:mt-[80px]">
      <div className="w-11/12 mx-auto ">
        <div className=" flex items-center h-[80px] md:h-[90px] gap-2">
          <h2 className="text-center text-[14px] md:text-[16px] font-bold">
            Internships with{" "}
            <span className="text-[#4250AC] text-[17px] md:text-[20px]">
              Dream companies.
            </span>
          </h2>
