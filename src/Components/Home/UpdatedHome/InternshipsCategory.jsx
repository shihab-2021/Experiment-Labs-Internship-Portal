...
const InternshipsCategory = () => {
    return (
        <div className='w-11/12 mx-auto mt-[70px]'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4  gap-7 mt-6 mx-auto'>
                <div className='flex gap-2 items-center justify-center border border-[#D3D3D3] py-[12px] px-[58px] rounded-3xl'>
                    <img src={xd} alt="" />
                    <p className='sm:text-[18px] md:text-[24px]'>Design</p>
                </div>

                <div className='flex gap-2 items-center justify-center border border-[#D3D3D3] py-[12px] px-[58px] rounded-3xl'>
                    <img src={bxdata} alt="" />
                    <p className='sm:text-[18px] md:text-[24px]'>Data analytics</p>
                </div>
                <div className='flex gap-2 items-center justify-center border border-[#D3D3D3] py-[12px] px-[58px] rounded-3xl'>
                    <img src={marketing} alt="" />
                    <p className='sm:text-[18px] md:text-[24px]'>Marketing</p>
                </div>
                <div className='flex gap-2 items-center justify-center border border-[#D3D3D3] py-[12px] px-[58px] rounded-3xl'>
                    <img src={finance} alt="" />
                    <p className='sm:text-[18px] md:text-[24px]'>Finance</p>
                </div>
            </div>
            <div className='flex justify-center  gap-10 mt-8'>
                <div className='flex gap-2 items-center justify-center border border-[#D3D3D3] py-[12px] px-[58px] rounded-3xl'>
                    <img src={content} alt="" />
                    <p className='sm:text-[18px] md:text-[24px]'>Content Writer</p>
                </div>
                <div className='flex gap-2 items-center justify-center border border-[#D3D3D3] py-[12px] px-[58px] rounded-3xl'>
                    <p className='sm:text-[18px] md:text-[24px] text-[#4250AC]'>Explore All</p>
                </div>
            </div>
        </div>
    );
